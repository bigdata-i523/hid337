...
In this application, an average k-fold cross validation accuracy of 0.99 achieved, which is explained in the appendix section of the report. Figure(\ref{fig:Figure8}) shows Classification and Confusion report output obtained from the KNN model we used for this project.
