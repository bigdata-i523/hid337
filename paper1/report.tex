...
\begin{abstract}
Having an intelligent ear-and-eye monitoring at the home to constantly observe the surroundings both inside and outside can protect the house and personnel much more safer way. By extending this capability to the neighborhood and city through collaboration would create safe cities across the world.Smart Security systems equipped with Video and Audio sensors produce huge amounts unstructured data continuously. 
This paper talks about high level architecture of an intelligent security system with video surveillance,  audio monitoring/recording, video and Audio analytics, alerting homeowners/authorities/agencies as needed. Big Data analytics becomes critical in supporting these modern applications.
...
\keywords{i523,hid337,hid333,Big Data,AI,Deep Learning}
