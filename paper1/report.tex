...
\affiliation{%
  \institution{I523}
  \streetaddress{366 FLORAL VIEW}
  \city{IRVINE} 
  \state{CA} 
  \postcode{92618}
}
\email{ashok.singam@gmail.com}
...
\begin{abstract}
Analyze audio, video data (captured continuously using voice, video sensors) and then provide analytics to homeowners/authorities/agencies as needed.
\end{abstract}
