...
There are some networking issues like synchronization, interference management etc involved during collaboration of aerial systems consisting of multiple small autonomous drones.Experiments are performed to evaluate aerial to aerial and aerial to ground communication over WLANs, various IEEE 802.11 WLAN variants, and specific antenna designs. The overall conclusion is IEEE 802.11 WLAN hardware is not well suited for 3D communication. High variance in throughput, non-predictable latency, multi-UAV network disruptions. A reliable wireless technology that can sustain high throughput as well as low delays and jitter over long ranges is still to be developed.
...
\begin{itemize}
  ...
  \item Outlined Sections and Subsections 
  \item 
  \item 
  \item 
  \item 
...
\begin{itemize}
  \item Setup LaTex template at sharelatex.com and removed unnecessary sections
